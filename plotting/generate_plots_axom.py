...
mode="classification"
datasets={"classification": ["gaussianLinear", "gaussianNonLinearAdditive", "gaussianPiecewiseConstant"]}
...
for metric in metrics:
    ...
    for data_idx, dataset in enumerate(datasets[mode]):
        ...
        for idx, model in enumerate(models):
            ...
            if idx == 0:
                if (num_models==1):
                    axs[data_idx].set_ylabel(dataset, fontsize=14)
                else:
