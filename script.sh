...
do
    ...
    do
        python main_driver.py --mode classification --seed 7 --experiment --experiment-json configs/experiment_config.jsonc --rho $rho --dataset $dataset --results-dir $output_path &
    done
    wait
done
wait